...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 3:
        ...
        while not ctrl_c:
            ...
            if  0.95 < abs(inc_x) < 1.05 and  0.95 < abs(inc_y) <1.05:
                cmd.linear.x = 0.00
                ...
                cmd.angular.z = 0.05       
           # rospy.loginfo("Current vel %s", theta_3)   
            '''
            if  0.5 > trans[0] > 1:
                 x_data1 = 1
            ...
            if x_data1 == 0 and y_data == -1:
                ...
                setpoint_stop = 2
                kp = 1.8;ki = 0.006;kd = 0.01;    upper = 0.36; lower = 0.0
                cmd.linear.y = -pid(trans[1],setpoint_stop,kp,ki,kd,dt,upper,lower)
                cmd.angular.z = 0.2
